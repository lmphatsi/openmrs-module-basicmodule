 ...
 */
package org.openmrs.module.mphatsi.web.controller;
 ...
 * 'module/mphatsi/basicmoduleLink.form'.
 */
@Controller
@RequestMapping(value = "module/mphatsi/basicmoduleLink.form")
public class BasicModuleFormController {
	...
	private final String SUCCESS_FORM_VIEW = "/module/mphatsi/basicmoduleForm";
